...
- never copies external SVG assets;
...
| `--asset-dir` | directory | directory containing the YAML input | source root for local SVG assets |
...
- resolves only external SVG assets referenced by compiled runtime data;
